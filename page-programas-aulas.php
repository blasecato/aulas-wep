				...
				if ($cardPrograms->have_posts()):
					while ($cardPrograms->have_posts()):
						...
						<div class="card-info card-info--<?php echo the_field("backgroundColorSomos"); ?>">
							...
							<?php the_content(); ?>
							<a href="<?php echo the_field("urlSeeMore"); ?>" class="see-more see-more--dark">conoce más</a>
						</div>
					<?php endwhile;
				endif;
				wp_reset_postdata();
						...
						while ($weSeek->have_posts()):
							...
							<div>
								<button id="<?php echo the_field("identificador"); ?>" class="tabs__tab">
									<img src="<?php echo "$urlTemplate/assets/images/arrow-down.svg" ?>" alt="item" class="item item-down" />
				...
				if ($components->have_posts()):
					while ($components->have_posts()):
						...
						<button class="items-item" id="<?php echo the_field("identificador"); ?>">
							<img src="<?php echo "$urlTemplate/assets/images/arrow-orange-down.png" ?>" alt="item" class="orange" />
			...
			<div class="cards">
				...
				if ($CardAchieve->have_posts()):
					while ($CardAchieve->have_posts()):
						...
						?>
						<div class="cards__card-info" style="background-color: <?php echo the_field("backgroundColorSomos"); ?>;">
							<h3 class="cards__card-info--title">
								<?php the_title(); ?>
							</h3>
							<a href="<?php echo the_field("urlCardInfo"); ?>" class="see-more"
								style="background-color: <?php echo the_field("colorSeeMore"); ?>;">conoce más</a>
						</div>
					<?php endwhile;
				endif;
				wp_reset_postdata();
